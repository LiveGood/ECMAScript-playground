...
function _classStaticPrivateFieldSpecGet(receiver, classConstructor, descriptor) { if (receiver !== classConstructor) {
...
var RemainderPrinter = /*#__PURE__*/ function () {
    ...
    function RemainderPrinter(_ref) {
        var _str3 = _ref.str1, _str4 = _ref.str2, startCount = _ref.startCount, endCount = _ref.endCount, remainderArgs = _ref.remainderArgs;
        ...
        _getCountString.set(this, {
            ...
            value: function value(num) {
                var _this$remainderArgs = _slicedToArray(this.remainderArgs, 2), remainder1 = _this$remainderArgs[0], remainder2 = _this$remainderArgs[1];
                if (_classStaticPrivateFieldSpecGet(RemainderPrinter, RemainderPrinter, _checkRemainder).call(RemainderPrinter, num, remainder1) && _classStaticPrivateFieldSpecGet(RemainderPrinter, RemainderPrinter, _checkRemainder).call(RemainderPrinter, num, remainder2))
                    return _classPrivateFieldGet(this, _getStringResult).call(this, _classStaticPrivateFieldSpecGet(RemainderPrinter, RemainderPrinter, _PRINT_BOTH));
                else if (_classStaticPrivateFieldSpecGet(RemainderPrinter, RemainderPrinter, _checkRemainder).call(RemainderPrinter, num, remainder1))
                    return _classPrivateFieldGet(this, _getStringResult).call(this, _classStaticPrivateFieldSpecGet(RemainderPrinter, RemainderPrinter, _PRINT_FIRST));
                else if (_classStaticPrivateFieldSpecGet(RemainderPrinter, RemainderPrinter, _checkRemainder).call(RemainderPrinter, num, remainder2))
                    return _classPrivateFieldGet(this, _getStringResult).call(this, _classStaticPrivateFieldSpecGet(RemainderPrinter, RemainderPrinter, _PRINT_SECOND));
                else
                    return num;
            }
        });
...
var _set_setBothResults = function _set_setBothResults(_ref2) {
    var str1 = _ref2.str1, str2 = _ref2.str2;
